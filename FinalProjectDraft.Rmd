...
## 1. Ellie and Ai: Introduction and Motivation 
...
The dataset in this study (https://www.kaggle.com/datasets/yekenot/tree-survival-prediction/data) comes from the article "tree seedling functional traits mediate plant-soil feedback survival responses across a gradient of light availability" by Wood et al (https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0293906#sec002). In the article, the authors conducted a field experiment with four tree species planted in seven soil sources (sterilized conspecific, live conspecific, and five heterospecific) and under a gradient of forest understory light levels (low, medium, and high). 
