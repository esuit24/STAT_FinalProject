...
Relevant character variables include Plot, Species, Conspecific, Soil, PlantDateMonth, and PlantDateDay.
Relevant numerical variables include EMF and Phenolics.

```{r Coxph}
# Coxph
coxph_tree <- coxph(Surv(Time, Event) ~ Species + Conspecific + SoilMyco + Sterile + Light_ISF + Soil + EMF + Phenolics + PlantDateMonth + PlantDateDay + Plot,
                      data=tree)
